...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "bluexc"))))
 ...
 '(minibuffer-prompt ((t (:foreground "yellow"))));;Change!
 ...
 '(gui-element ((t (:background "#D4D0C8" :foreground "grey75"))))
 '(region ((t (:background "#27292A"))))
 '(mode-line ((t (:background "grey75" :foreground "#111111"))))
 '(highlight ((t (:background "#111111"))))
 '(highline-face ((t (:background "SeaGreen"))))
 '(left-margin ((t (nil))))
 '(text-cursor ((t (:background "yellow" :foreground "yellow"))))
 '(toolbar ((t (nil))))
